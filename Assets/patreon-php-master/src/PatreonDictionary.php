...
enum PatreonCampaign : string
{
  ...
  public function SessionID(): string
  {
    switch($this->value)
    {
      ...
      case "12636483": return "isForceFamPatron";
  ...
  public function IsTeamMember($userName): string
  {
    switch($this->value)
    {
      case "0": return ($userName == "MrShub" || $userName == "duofanel" || $userName == "Matiisen" ||  $userName == "Pepowski" ||  $userName == "Seba_stian" ||  $userName == "dvooyas" || $userName == "Lukashu" || $userName == "Qwak" || $userName == "NatAlien");
  ...
  public function CardBacks(): string
  {
    switch($this->value)
    {
      ...
      case "12636483": return "14";
      case "13088942": return "38";
      default: return "";
    }
  }
}
